...
/**
 * This is the debug utility for Myriad. It is a slightly modified version of
 * the robot judge. The input file has reads FEN strings line by line. Start a
 * line with * to have the string treated as a comment.
 * 
 * @author Jesse Wang
 */
public abstract class Debug {
	...
	/**
	 * This is a testing utility. It allows you to specify a general comment
	 * along with the test cases describing the test. This outputs a file in the
	 * debug folder with a name specified by the user.
	 * 
	 * @param testFileName
