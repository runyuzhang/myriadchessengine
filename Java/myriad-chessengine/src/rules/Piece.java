...
/**
 * This is the piece object, this object contains a hexadecimal location, piece
 * type and colour. Once you instantiate a piece object, it is considered
 * immutable, that means, the contents cannot be changed. You must reassign your
 * variables to achieve the desired effect, like with a string.
 * 
...
public final class Piece {
	...
	private byte pos;
	/**
	 * The type of the piece, read the public elements for the corresponding
	 * ID's
	 */
	private byte ptype;
	...
	private static final Piece NULL_PIECE = new Piece((byte) -1, (byte) -1,
			(byte) 0);
	...
	// ----------------------Constructors----------------------
	/**
	 * Makes a piece with the given position 0x88 coordinate and type (and state
	 * = true).
	 * 
	 * @param x88loc
	 *            the 0x88 location of the piece.
	 * @param ptype
	 *            the type of the piece (pawn, knight, etc..) according to the
	 *            constants.
	 * @param colour
	...
	/**
	 * Moves a piece a 0x88 difference in decimal, that is, the difference
	 * between 0x58 and 0x70 is actually not 12. It's 18. You need to put 18 for
	 * this method to work properly. Also, like Strings, you MUST reassign your
	 * variable, ex. <code>
	 * Piece p = new Piece (32, 4, 3);
	 * p = p.move (15)
	 * </code> Note: You <i>can</i> actually move your piece out of the board.
	 * Just use the exists() method to test whether or not it is out of the
	 * board.
	 * 
	 * @param difference
	 *            between the squares in decimal.
	 * @return A new Piece of the same type and colour, but a different
	 *         location.
	 */
	...
	/**
	 * Applies a Move m to this object. This returns a new object with the move
	 * applied to it. This means you must reassign your variable.
	 */
	...
	/**
	 * Returns the "null piece", or a piece that has no defined colour or piece
	 * type. You must reassign to get this effect. ex. <code>
	 * Piece p = new Piece (32, 4, 3);
	 * p = p.destroy();
	 * </code>
	 * 
	...
	/**
	 * Returns the null piece. A piece that has no valid colour or type and at a
	...
	public boolean isEqual(Piece other) {
		return other.getPosition() == pos && other.getType() == ptype
